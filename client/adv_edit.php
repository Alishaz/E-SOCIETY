 ...
 <div class="footer-top"></div>
   ...
   <hr />
    	 &nbsp;&nbsp;<table align="center" border="1">
            ...
            <tr>
            	<td colspan="2" align="center"> <input type="submit" name="submit" value="Update" class="button" onclick="return validate();">&nbsp;&nbsp;
<input type="button" value="Back" name="button" class="button" onclick="window.location='adv1_display.php';"/></td>
            </tr>
        </table>
    </center>
</form>			
