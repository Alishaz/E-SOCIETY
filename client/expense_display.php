...
<?php
	...
	if(isset($_POST['search']) && $_POST['search']='Search')
	{
		...
		$src=" WHERE exp_year LIKE '%$keyword%' OR exp_amt LIKE '%$keyword%' OR exp_sub LIKE '%$keyword%'";	
	} 
...
<div align="right">
        ...
        <input type="button" value="Show All" name="show all" class="button" onClick="window.location='expense_display.php';">
        </div>
</form>
<br >
...
<!----------------pagination second part-------------------->
    ...
    <!--------------------pagination sec part complete-------------->			
    	  <tr align="left">
				<td><?php echo $fet['exp_year'];?></td>
                <td><?php echo $fet['exp_amt'];?></td>
                <td><?php echo $fet['exp_sub'];?></td>
			</tr>
