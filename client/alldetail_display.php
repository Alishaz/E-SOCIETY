...
?>
 <div class="footer-top"></div>
       <form method="post" enctype="multipart/form-data" name="allprofile" id="allprofile">
       <center>
    <h2>Members Profile Detail</h2></center>
    <hr />
    &nbsp;&nbsp;
    	
    	 <?php
	   	$id=$_GET['pro_id'];
	   $sel="select * from profile where pro_id='$id'";
...
<?php echo str_repeat("&nbsp;",12); ?> <input type="button" name="button" value="Back" class="button" onclick="window.location='allmember_display.php';"/></a>
