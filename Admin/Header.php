  ...
  <div id="menu" class="menu opacity">
    <ul>
      ...
      <li><a href="">Portfolio</a>
        <ul>
        	<li><a href="member_display.php">Members List</a></li>
        	<li><a href="adv_display.php">Advertisement</a></li>
            <li><a href="event_display.php">Events</a>
          <ul><li><a href="place_display.php">Permission Request Detail</a></li>
          <li><a href="response_display.php">Permission Response Detail</a></li></ul></li>
          <li><a href="gallery_display.php">Gallery</a></li>
          <li><a href="news_display.php">News</a></li>
      ...
      <li><a href="">Services</a>
        ...
        <li><a href="meeting_display.php">Meetings</a></li>
          ...
          <li><a href="memb_bill.php">Maintenance</a></li>
