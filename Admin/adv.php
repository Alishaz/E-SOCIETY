...
?>
 <div class="footer-top"></div>
    ...
    <tr>
   	<td>Name</td>
        <td>&nbsp;<input type="text" name="adv_name" id="adv_name" /></td>
    </tr>
    <tr>
    	<td>Mobile No.</td>
    ...
    <tr>
     ...
     <tr>
     	 <td colspan="2" align="center"><span class="button-row">
     	   <input type="submit" value="Submit" name="submit" class="button" onclick="return valid_data();" />
           <input type="reset" value="Cancel" name="reset" class="button" onclick="window.location='adv_display.php';"  />
     	 </span></td>
     </tr>
    </table>	
</center>
