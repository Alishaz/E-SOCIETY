...
<form id="mainform" action="">
                ...
                <br /><tr>
              <center> <b><font size="6" color="#333333">Maintenance Bill</font></b></center>
              
                </tr>
				</br></br>             <tr>
                <th class="table-header-repeat line-left"><a href="">ID</a>	</th>
					<th class="table-header-repeat line-left minwidth-1"><a href="">Name</a>	</th>
                    	<th class="table-header-repeat line-left minwidth-1"><a href="">MAintenance Amount</a>	</th>
                    <th class="table-header-repeat line-left"><a href="">Months</a></th>
					<th class="table-header-repeat line-left minwidth-1"><a href="">Total Amount</a></th>
			...
			?>
			<tr>
				 <td><?php echo $f['main_id'];?></td>
                            <td><?php echo $f['uname'];?></td>
                            <td><?php echo $f['fix_amt'];?></td>
							 <td><?php echo $f['months'];?></td>
                              <td><?php echo $f['tot_amt'];?></td>  
